...
namespace Rocks.Profiling.Internal.Helpers
{
    ...
    public static class StackTraceExtensions
    {
        ...
        /// <param name="predicate">Methods predicate.</param>
        /// <returns>An async-friendly readable representation of the stack trace.</returns>
        public static string ToAsyncString(this StackTrace stackTrace, Func<MethodBase, bool> predicate)
        {
            if (stackTrace == null)
            ...
            foreach (var frame in stackFrames)
            {
                ...
                // skip awaiters
                if (method == null || typeof (INotifyCompletion).IsAssignableFrom(method.DeclaringType) || !predicate(method))
                    continue;
